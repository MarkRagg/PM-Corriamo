...
I partecipanti a queste sessioni sono i membri del team di sviluppo insieme al committente. Il committente rappresenterà anche gli stakeholder, che non saranno presenti a questi meeting per non investire troppo tempo in fasi che non li riguardano direttamente. Non ci sarà la figura di _Facilitator_, in quanto il team IT è ristretto e tutti gli sviluppatori saranno incaricati di seguire questo progetto.  

Ogni sessione verrà svolta nell'apposita aula riunioni all'interno dell'azienda, per garantire velocità negli spostamenti ma anche comodità delle sedie, molti attrezzi a disposizione tra cui lavagne e proiettore, utili per la stesura di documenti.

### Partecipanti 

| Nome                 | Ruolo                                                       |
|----------------------|-------------------------------------------------------------|
| **Marco Raggini** | Committente |
| **Simone Zama** | Project Manager, Programmatore |
